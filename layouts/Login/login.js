      ...
      <View style={styles.container}>
        <View>
          ...
          <Text style={styles.caption}>
            Selamat datang di SportWave, berita terbaru, terupdate, terpercaya.
          </Text>
              ...
              <View
                ...
                <TouchableOpacity onPress={togglePasswordVisibility}>
                  {passwordVisible ? (
                    ...
                    <EyeSlash variant="Linear" color={'gray'} size={20} />
                  )}
                </TouchableOpacity>
              </View>
            </View>
        ...
        <View style={{gap: 10}}>
          <TouchableHighlight
            style={[
              button.container,
              {
                backgroundColor: isLoginDisabled ? 'grey' : 'grey',
              },
            ]}
            underlayColor={'grey'}
            onPress={handleLogin}
          ...
          <View style={{flexDirection: 'row', gap: 5, alignSelf: 'center'}}>
            ...
            <TouchableOpacity onPress={() => navigation.navigate('Register')}>
              <Text style={[button.label, {color: 'blue(0.8)'}]}>Sign up</Text>
            </TouchableOpacity>
          </View>
        </View>
      </View>
